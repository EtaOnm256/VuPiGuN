    ...
    private void Awake()
    {
       _slashMotionInfo = new Dictionary<RobotController.LowerBodyState, SlashMotionInfo>
       {
        ...
        _motionProperty = new Dictionary<RobotController.LowerBodyState, MotionProperty>
            {
                { RobotController.LowerBodyState.GROUNDSLASH_DASH,new MotionProperty{DashSpeed = 30.0f ,DashLength = 45 ,SlashDistance=6.0f,SlashDistance_Min = float.MaxValue} },
                { RobotController.LowerBodyState.AIRSLASH_DASH,new MotionProperty{DashSpeed = 45.0f ,DashLength = 45/2,SlashDistance=6.0f,SlashDistance_Min = float.MaxValue } },
              //  { RobotController.LowerBodyState.LowerSlash,new SlashMotionInfo(1) },
                 { RobotController.LowerBodyState.QUICKSLASH_DASH,new MotionProperty{DashSpeed = 45.0f ,DashLength = 45/2 ,SlashDistance=6.0f,SlashDistance_Min = float.MaxValue} },
                 { RobotController.LowerBodyState.DASHSLASH_DASH,new MotionProperty{DashSpeed = 60.0f ,DashLength = 45/2,SlashDistance=6.0f,SlashDistance_Min = float.MaxValue } },
            };
