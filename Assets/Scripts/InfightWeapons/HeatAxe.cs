...
public class HeatAxe : InfightWeapon
{
    ...
    private void Awake()
    {
        ...
        _slashMotionInfo = new Dictionary<RobotController.LowerBodyState, SlashMotionInfo>
        {
            ...
            {
                { RobotController.LowerBodyState.GROUNDSLASH_DASH,new MotionProperty{DashSpeed = 20.0f ,DashLength = 67 ,SlashDistance = 4.5f,RotateSpeed=4.0f,SlashDistance_Min = float.MinValue} },
                { RobotController.LowerBodyState.AIRSLASH_DASH,new MotionProperty{DashSpeed = 30.0f ,DashLength = 67/2,SlashDistance = 4.5f,RotateSpeed=4.0f,SlashDistance_Min = float.MinValue } },
              //  { RobotController.LowerBodyState.LowerSlash,new SlashMotionInfo(1) },
                 { RobotController.LowerBodyState.QUICKSLASH_DASH,new MotionProperty{DashSpeed = 30.0f ,DashLength = 67/2,SlashDistance = 4.5f,RotateSpeed=4.0f,SlashDistance_Min = float.MinValue } },
                 { RobotController.LowerBodyState.DASHSLASH_DASH,new MotionProperty{DashSpeed = 40.0f ,DashLength = 67/2,SlashDistance = 4.5f,RotateSpeed=4.0f,SlashDistance_Min = float.MinValue } },
            };
