Shader "Custom/TerrainLit_SkyboxFog"
{
    Properties
    {
        ...
        _SkyCubemap("SkyCube", Cube) = "defaulttexture" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Shaders/TerrainLitInput_SkyboxFog.hlsl"
            #include "Assets/Shaders/TerrainLitPasses_SkyboxFog.hlsl"
            ENDHLSL
        }
